...
function LoginDokter() {
  ...
  const handleSubmit = (values) => {
    ...
    axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/doctor/login`, values).then(response => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900" style={{
      ...
      <div className="bg-green bg-opacity-30 backdrop-blur-md p-8 sm:p-10 rounded-xl shadow-2xl w-full max-w-md border border-white border-opacity-30">
        ...
        <h2 className="text-3xl font-bold text-white text-center mb-6">Login Dokter</h2>
        ...
        <div className="mt-6 text-center text-sm text-white">
          ...
          <div className="flex flex-row justify-center gap-5 mt-2">
            <Button className="!bg-white text-black cursor-pointer hover:!bg-gray-200" onClick={() => navigate('/login')}>Pasien</Button>
